...
import net.mcreator.morecookie.block.Racepadv2Block;
...
import net.mcreator.morecookie.block.Boostpadv2Block;
...
public class MoreCookieModBlocks {
	...
	public static final RegistryObject<Block> BOOSTPADV_2 = REGISTRY.register("boostpadv_2", () -> new Boostpadv2Block());
	public static final RegistryObject<Block> RACEPADV_2 = REGISTRY.register("racepadv_2", () -> new Racepadv2Block());
